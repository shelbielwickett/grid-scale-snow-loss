...
# PySAM simulation
def pysam(year, scenario_folder_name: str, log_file_path):
    ...
    with open(log_file_path, 'a') as log_file:
        ...
        for i, site_key in enumerate(site_dict):
            ...
            # Define output path
            output_path = BASE_DIR / f'PySAM_Results/Existing_Sites_Results/{scenario_folder_name}/{year} SAM Results/{site_data["Project Name"]}_{year}_Results.csv'
            ...
            try:
                ...
                directory = BASE_DIR / f'PySAM_Results/Existing_Sites_Results/{scenario_folder_name}/{year} SAM Results/'
...
#Run both scenarios
def main() -> int:
    pysam(year, "Roof_Slide_Coeff", log_file_path)
    pysam(year, "No_Snow", log_file_path)
